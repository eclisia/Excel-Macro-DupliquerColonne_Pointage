...
'
'   Version 02 :
'   Ajout d'une fonction qui permet de retirer les filtres activés sur la page avant toute chose. Car sinon, le reste de la macro plante
    ...
    '   Display all data and thus "disabled" previous filter
    With myWS
